...
c_measure_distance = GoalModel("measure_distance", a_measure_distance, g_measure_distance)
...
c_keep_short_distance = GoalModel("keep_short_distance", a_keep_short_distance, g_keep_short_distance)

a_communicate_leader = [s_network, s_rssi > RSSI_net]
g_communicate_leader = [v_leader >= 0, s_leader <= 1, s_leader >= -1]
c_communicate_leader = GoalModel("communicate_leader", a_communicate_leader, g_communicate_leader)


a_follow_leader = [v_leader >= 0]
g_follow_leader = [vel_ego_t1 == v_leader, vel_ego_t == v_leader]
c_follow_leader = GoalModel("follow_leader", a_follow_leader, g_follow_leader)
